...
class RunnerEntryAuthorizer:
    """Two-observation P0-3B-D guard for the only adapter BUY dispatch path."""
    MAX_SNAPSHOT_AGE_SECONDS = Decimal("2")

    def __init__(self, *, broker, state_store, kill_switch_file, capital_limit, daily_loss_limit):
        self.broker = broker
