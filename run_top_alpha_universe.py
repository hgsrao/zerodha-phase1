...
# Pure Alpha Universe: Filtered for mean-reverting fidelity
TARGET_SYMBOLS = [
...
def run():
    ...
    print(f"Precomputing features for Alpha Universe: {TARGET_SYMBOLS}...")
    symbol_frames = {}
    ...
    print("\nExecuting Alpha Universe Replay (Slot Capital: ₹3.33L)...")
    ...
    for t in all_timestamps:
        ...
        for sym, pos in active_positions.items():
            ...
            # Balanced harvest: z-target reached + at least 0.35R gain to clear friction
    ...
    print("\n" + "=" * 75)
    print("ALPHA UNIVERSE RESULTS (JULY 2023)")
    print("=" * 75)
