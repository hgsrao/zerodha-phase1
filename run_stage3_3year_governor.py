...
def run():
    ...
    print("Running Stage 3 (Full Historical Dataset: 2023 - 2026)...")
    ...
    for i, fpath in enumerate(csv_files, 1):
        ...
        try:
            ...
            if len(raw) < 500:
                continue
            df = compute_causal_features(raw)
        except Exception:
            continue
    ...
    print("\n" + "=" * 75)
    print("STAGE 3 (FULL 3-YEAR REPLAY) SOVEREIGN DROOP GOVERNOR RESULTS")
    print("=" * 75)
