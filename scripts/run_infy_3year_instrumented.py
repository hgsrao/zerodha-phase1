...
STATS_PATH = OUTPUT_DIR / "infy_3year_box_stats.json"
PROGRESS_PATH = OUTPUT_DIR / "infy_3year_progress.jsonl"
SUMMARY_PATH = OUTPUT_DIR / "infy_3year_summary.json"
...
def instrument_and_run():
    ...
    arctic_db_path = str(OUTPUT_DIR / "arctic_infy_3year_db")
