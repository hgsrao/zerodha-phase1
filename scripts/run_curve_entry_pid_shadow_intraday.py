...
def main() -> None:
    ...
    p.add_argument("--relative-tolerance", type=float, default=.10); p.add_argument("--warmup", type=int, default=124); p.add_argument("--output")
    ...
    ledger=StudyEntryShadowLedger(); pid=CurveEntryPidShadow(a.phase_center,a.phase_tolerance,a.relative_tolerance)
    sync=CurveSynchronizerShadow(ledger, phase_center_degrees=a.phase_center, phase_tolerance_degrees=a.phase_tolerance, entry_pid=pid)
