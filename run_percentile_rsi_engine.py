...
class ProductionEngineWithPercentileRSI:
    ...
    def execute_backtest(self):
        ...
        # Calculate Rolling Percentile RSI (100-bar lookback, bottom 5th percentile)
        ...
        for pos in range(120, len(df) - 40):
            ...
            # Cascaded Entry Gates (Replacing static RSI < 28 with rolling 5th percentile rank)
    ...
    def print_performance(self):
        print('=' * 60)
        print(f'PERCENTILE RSI ENGINE PERFORMANCE REPORT: {self.symbol}')
        print('=' * 60)
...
if __name__ == '__main__':
    engine = ProductionEngineWithPercentileRSI('MARUTI')
