...
class StatefulMockBroker:
    ...
    def ltp(self, symbols):
        ...
        for symbol in symbols:
            ...
            elif symbol in self._ltp:
                res[symbol] = copy.deepcopy(self._ltp[symbol])
        return res
    ...
    def set_ltp(self, symbol, price):
        ...
        self._ltp[symbol] = {"last_price": float(price)}
...
class TestV340BManagementLifecycle(unittest.TestCase):
    ...
    def test_reg_b02_partial_entry_persistence(self):
        ...
        self.assertEqual(engine.state.active_trade.filled_qty, 4)
    ...
    def test_reg_b08_partial_sl_fill_cumulative_stability(self):
        ...
        engine.step()
        self.assertFalse(terminator.halted, f"Unexpected HARD HALT: {terminator.reason}")
        self.assertEqual(engine.state.active_trade.filled_qty, 2)
    ...
    def test_reg_b09_repeated_identical_fills_stability(self):
        ...
        self.assertFalse(terminator.halted, f"Unexpected HARD HALT: {terminator.reason}")
        self.assertEqual(engine.state.active_trade.filled_qty, 7)
