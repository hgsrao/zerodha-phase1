...
def run():
    ...
    print("Running Stage 2 (1 Full Year: July 2023 - June 2024)...")
    
    for i, fpath in enumerate(csv_files, 1):
        symbol = fpath.name.split('_')[1]
        print(f"[{i:02d}/48] Processing {symbol}...", end='\r')
        try:
    ...
    print("\n" + "=" * 75)
    print("STAGE 2 (1-YEAR) CLOSED-LOOP ECS SUPERVISOR RESULTS")
    print("=" * 75)
